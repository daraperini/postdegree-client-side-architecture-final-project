...
// função do next.js que especifica quais rotas dinâmicas devem ser pré-renderizadas
export async function generateStaticParams() {
  //função que retorna um array de objetos que representam as rotas dinâmicas que devem ser pre-renderizadas
  const { characters } = await getAllCharacters()

  //retorna cada personagem incluindo uma slug determinada pelo valor de slug do objeto. Faz a pré-renderização utilizando a slug para identificar os caminhos.
