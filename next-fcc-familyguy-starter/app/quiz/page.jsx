...
export async function getRandomQuizQuestion() {
  ...
  // { cache: 'no-store' } garante que a página não vai ser gerada estaticamente (desabilita cache). Faz o request pra API pegar novo data toda vez que o usuário visita a página.
